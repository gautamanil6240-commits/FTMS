...
from datetime import date  # 🧠 Cleaned up import location
...
class Player(models.Model):
    ...
    # --- Personal Info ---
    # Add a temporary default string right here to satisfy the migration engine
    ...
    def age(self):
        ...
        today = date.today()
        # Uses the boolean evaluation trick: Subtracts 1 if the birthday hasn't happened yet this year
